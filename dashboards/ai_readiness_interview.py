...
Embeds the React interview artifact (hfm-interview-arr) via st.components.html().
...
render_header(
    "AI Readiness Review",
    "Stakeholder interview tool for AI readiness diagnostic",
    goals=["G5"],
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  textarea:focus, input:focus { outline: none; border-color: rgba(6,182,212,0.5) !important; }
...
""" + open(
    str(__import__("pathlib").Path(__file__).resolve().parent.parent / "artifacts" / "hfm-interview-arr.jsx")
).read() + """
</script>
</body>
</html>
