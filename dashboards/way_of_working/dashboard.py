...
if not is_configured():
    st.markdown(
        ...
        "<div style='font-size:48px;margin-bottom:16px;'>\U0001f4cb</div>"
        "<h2 style='color:{};'>Way of Working</h2>"
        "<p style='color:#717171;max-width:500px;margin:0 auto 24px;'>"
        "This section connects to Monday.com to track Harris Farm's "
        "100 strategic initiatives across all 5 pillars.</p>"
        "<div style='background:rgba(0,0,0,0.03);border-radius:10px;padding:20px;"
        "max-width:400px;margin:0 auto;text-align:left;'>"
        "<div style='font-weight:600;margin-bottom:8px;'>"
        "\u2699\ufe0f Setup Required</div>"
        "<ol style='color:#717171;font-size:13px;margin:0;padding-left:20px;'>"
