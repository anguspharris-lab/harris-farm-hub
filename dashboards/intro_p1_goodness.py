...
with c1:
    st.markdown(
        ...
        "<div style='font-size:12px;color:#717171;'>Renewable Energy</div>"
        "<div style='font-size:12px;color:#2D6A2D;margin-top:4px;'>"
        "\u2713 Achieved</div>"
...
st.markdown(
    ...
    "<p style='color:#4A4A4A;'>Harris Farm's purpose goes beyond selling fresh food. "
    ...
    "<p style='color:#717171;font-size:13px;font-style:italic;'>"
