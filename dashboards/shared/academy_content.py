...
# ---------------------------------------------------------------------------
# DAILY CHALLENGE POOL — 60+ challenges for deterministic daily rotation
# ---------------------------------------------------------------------------

DAILY_CHALLENGE_POOL = [
    # Prompt Writing — Beginner
    {"code": "pw_b01", "title": "Rewrite a Vague Prompt", "description": "Take this prompt: 'Tell me about sales' — rewrite it to be specific, contextual, and actionable for Harris Farm.", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 20, "target_level": "Seed"},
    {"code": "pw_b02", "title": "Add Context to a Prompt", "description": "Write a prompt asking AI to summarise last week's store performance. Include role, audience, format, and timeframe.", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 20, "target_level": "Seed"},
    {"code": "pw_b03", "title": "One-Shot Email Draft", "description": "Write a prompt that asks AI to draft a professional email to suppliers about a delivery delay. Be specific about tone and length.", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 20, "target_level": "Seed"},
    {"code": "pw_b04", "title": "Meeting Agenda Builder", "description": "Write a prompt asking AI to create a 30-minute team meeting agenda. Include the meeting purpose and expected outcomes.", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 20, "target_level": "Seed"},
    {"code": "pw_b05", "title": "Customer Complaint Response", "description": "Write a prompt that asks AI to draft a response to a customer complaint about produce quality. Specify the Harris Farm tone.", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 20, "target_level": "Seed"},
    {"code": "pw_b06", "title": "Simple Data Question", "description": "Write a prompt asking AI to explain what 'year-on-year growth' means in the context of weekly sales data.", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 20, "target_level": "Seed"},
    {"code": "pw_b07", "title": "Task List Generator", "description": "Write a prompt that asks AI to create a prioritised task list for opening a store in the morning. Include constraints.", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 20, "target_level": "Seed"},
    {"code": "pw_b08", "title": "Product Description Writer", "description": "Write a prompt asking AI to create a product description for a seasonal fruit box. Specify brand voice and target customer.", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 20, "target_level": "Seed"},
    # Prompt Writing — Intermediate
    {"code": "pw_i01", "title": "Chain of Thought Analysis", "description": "Write a prompt using the Chain of Thought pattern to analyse why a store's waste percentage increased last month. Break the reasoning into steps.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
    {"code": "pw_i02", "title": "Role + Constraint Prompt", "description": "Write a prompt that assigns AI the role of a category manager and asks it to recommend which 3 product lines to expand, with budget constraints.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
    {"code": "pw_i03", "title": "Few-Shot Example Prompt", "description": "Write a prompt with 2 examples showing how to classify customer feedback as positive/negative/neutral, then ask AI to classify 5 new comments.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
    {"code": "pw_i04", "title": "Structured Output Request", "description": "Write a prompt asking AI to produce a JSON table comparing 3 stores on sales, waste %, and customer count. Specify exact field names.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
    {"code": "pw_i05", "title": "Iterative Refinement", "description": "Write an initial prompt, then write 2 follow-up prompts that refine the output — narrowing scope, adding detail, and improving format.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    {"code": "pw_i06", "title": "Multi-Audience Report", "description": "Write a prompt asking AI to create a trading update that has 3 sections: exec summary (board), detail (ops team), and action items (store managers).", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    {"code": "pw_i07", "title": "Competitive Analysis Prompt", "description": "Write a prompt asking AI to compare Harris Farm's market positioning against Woolworths and Coles, using specific data points you provide.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    {"code": "pw_i08", "title": "Process Documentation", "description": "Write a prompt asking AI to document a process you know well (e.g., goods receiving, roster planning) as a step-by-step SOP.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    # Prompt Writing — Advanced
    {"code": "pw_a01", "title": "Context Loading Masterclass", "description": "Write a prompt that loads context (store data, market trends, seasonality) before asking AI to recommend a pricing strategy for summer stone fruit.", "type": "prompt_writing", "difficulty": "advanced", "xp_reward": 30, "target_level": "Harvester"},
    {"code": "pw_a02", "title": "Board Paper Draft", "description": "Write a prompt asking AI to draft a 1-page board paper on AI adoption at Harris Farm. Include structure, data points to reference, and strategic framing.", "type": "prompt_writing", "difficulty": "advanced", "xp_reward": 30, "target_level": "Harvester"},
    {"code": "pw_a03", "title": "Multi-Step Data Pipeline", "description": "Write a prompt chain (3+ steps) that: (1) cleans messy sales data, (2) calculates KPIs, (3) generates an insight summary with recommendations.", "type": "prompt_writing", "difficulty": "advanced", "xp_reward": 30, "target_level": "Cultivator"},
    {"code": "pw_a04", "title": "Strategic Decision Framework", "description": "Write a prompt asking AI to build a decision framework for new store site selection, incorporating demographics, competition, and catchment analysis.", "type": "prompt_writing", "difficulty": "advanced", "xp_reward": 30, "target_level": "Cultivator"},
    # Quiz challenges
    {"code": "qz_01", "title": "Name That Pattern", "description": "Which prompt pattern is this? 'You are a senior buyer. Given these supplier quotes [data], recommend the best 3 options and explain your reasoning step by step.'", "type": "quiz", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed", "metadata": {"answer": "Chain of Thought + Role Prompting"}},
    {"code": "qz_02", "title": "Spot the Missing Block", "description": "This prompt has 4 of the 5 building blocks: 'As a store manager [Role], create a weekly roster [Task] in table format [Format] for the deli team [Context].' What's missing?", "type": "quiz", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed", "metadata": {"answer": "Constraints (e.g., budget, max hours, availability)"}},
    {"code": "qz_03", "title": "Rubric Score Guess", "description": "Prompt: 'Make sales better.' — What would this score on the 25-point rubric? (A) 5-8, (B) 9-12, (C) 13-16, (D) 17-20", "type": "quiz", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed", "metadata": {"answer": "A (5-8) — too vague, no context, no format, no constraints"}},
    {"code": "qz_04", "title": "Which Level Am I?", "description": "Someone can write structured prompts with context, use Chain of Thought, and has completed 6 Learning Centre modules. Which Academy level best matches?", "type": "quiz", "difficulty": "intermediate", "xp_reward": 20, "target_level": "Sprout", "metadata": {"answer": "Grower"}},
    {"code": "qz_05", "title": "Best Practice Check", "description": "True or False: You should always tell the AI exactly what format you want the output in, even if it seems obvious.", "type": "quiz", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed", "metadata": {"answer": "True — explicit format requests dramatically improve output quality"}},
    {"code": "qz_06", "title": "5 Building Blocks Recall", "description": "Name all 5 building blocks of a great prompt. Hint: R, T, C, F, C.", "type": "quiz", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed", "metadata": {"answer": "Role, Task, Context, Format, Constraints"}},
    {"code": "qz_07", "title": "Pattern Match", "description": "Which pattern should you use when you need AI to produce output in a very specific structure (JSON, table, bullet points)?", "type": "quiz", "difficulty": "intermediate", "xp_reward": 20, "target_level": "Sprout", "metadata": {"answer": "Structured Output pattern"}},
    {"code": "qz_08", "title": "When NOT to Use AI", "description": "Name 3 scenarios at Harris Farm where you should NOT use AI and instead rely on human judgement.", "type": "quiz", "difficulty": "intermediate", "xp_reward": 20, "target_level": "Sprout", "metadata": {"answer": "E.g., final hiring decisions, customer confrontations requiring empathy, food safety sign-offs"}},
    # Score This challenges
    {"code": "st_01", "title": "Score This: Weekly Report Prompt", "description": "Score this prompt (1-5 on each of 5 criteria): 'As the operations manager, create a weekly performance summary for the Pyrmont store covering sales, waste, and customer count for last week. Format as 3 paragraphs with KPIs highlighted. Keep it under 300 words.'", "type": "score_this", "difficulty": "intermediate", "xp_reward": 20, "target_level": "Sprout"},
    {"code": "st_02", "title": "Score This: Vague Request", "description": "Score this prompt: 'Help me with the roster.' — Rate each of the 5 rubric criteria and explain what's missing.", "type": "score_this", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    {"code": "st_03", "title": "Score This: Data Analysis", "description": "Score this prompt: 'Analyse customer transaction data for Q4 to find the top 10 products by revenue, segment by store, and identify which stores are underperforming relative to their catchment size. Output as a markdown table.'", "type": "score_this", "difficulty": "intermediate", "xp_reward": 20, "target_level": "Sprout"},
    {"code": "st_04", "title": "Score This: Strategy Prompt", "description": "Score this prompt: 'You are a retail strategist. Given that Harris Farm's online share grew 2pp YoY while instore declined 0.5pp, draft a 1-page recommendation for the board on channel investment priorities. Include risk analysis.'", "type": "score_this", "difficulty": "advanced", "xp_reward": 25, "target_level": "Grower"},
    {"code": "st_05", "title": "Score This: Simple Task", "description": "Score this prompt: 'Write a thank-you note to a supplier who delivered early.' — What score would it get and how could it be improved?", "type": "score_this", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    {"code": "st_06", "title": "Score This: Perfect Prompt", "description": "Score this prompt: 'As a category manager at Harris Farm Markets [Role], analyse the attached produce margin data [Context] to identify the 5 categories with declining margins over the last 3 months [Task]. Present findings in a table with columns: Category, Current Margin %, 3-Month Trend, Root Cause Hypothesis, Recommended Action [Format]. Focus on categories where margin decline exceeds 2pp and exclude seasonal items [Constraints].'", "type": "score_this", "difficulty": "advanced", "xp_reward": 25, "target_level": "Grower"},
    # Pattern Practice
    {"code": "pp_01", "title": "Practice: Chain of Thought", "description": "Write a prompt using Chain of Thought to solve this: 'Should Harris Farm open a dark store for online orders?' Make the AI reason step by step.", "type": "pattern_practice", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
    {"code": "pp_02", "title": "Practice: Role Prompting", "description": "Write the same question 3 different ways using 3 different roles: CFO, Store Manager, and Customer. Notice how the role changes the answer.", "type": "pattern_practice", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
    {"code": "pp_03", "title": "Practice: Few-Shot Examples", "description": "Create a prompt with 3 examples of good product descriptions, then ask AI to write 5 more in the same style for seasonal items.", "type": "pattern_practice", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    {"code": "pp_04", "title": "Practice: Structured Output", "description": "Write a prompt that produces output in a specific JSON format with exactly these fields: store_name, metric, value, trend, recommendation.", "type": "pattern_practice", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    {"code": "pp_05", "title": "Practice: Constraint Setting", "description": "Write a prompt with at least 5 constraints (word limit, audience, exclude topics, required sections, tone).", "type": "pattern_practice", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
    {"code": "pp_06", "title": "Practice: Iterative Refinement", "description": "Write an initial prompt, get a response, then write 3 follow-up prompts that each make the output better. Show the progression.", "type": "pattern_practice", "difficulty": "advanced", "xp_reward": 30, "target_level": "Harvester"},
    {"code": "pp_07", "title": "Practice: Context Loading", "description": "Write a prompt that loads at least 3 different types of context (data, background, constraints) before asking the main question.", "type": "pattern_practice", "difficulty": "advanced", "xp_reward": 30, "target_level": "Harvester"},
    # Module Nudges
    {"code": "mn_01", "title": "Start a Module", "description": "Go to the Learning Centre and start (or continue) any module you haven't completed yet. Earn XP for the module AND this challenge!", "type": "module_complete", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    {"code": "mn_02", "title": "Complete a Module", "description": "Finish any Learning Centre module today. Full completion earns 50 XP from the module plus this daily bonus!", "type": "module_complete", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    {"code": "mn_03", "title": "Explore Data Modules", "description": "Open a Data or Analytics module in the Learning Centre. Even starting earns XP. See how data powers Harris Farm.", "type": "module_complete", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    {"code": "mn_04", "title": "Try AI Prompting Basics", "description": "Start the AI Prompting Basics module in the Learning Centre if you haven't already. Master the 5 building blocks.", "type": "module_complete", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    {"code": "mn_05", "title": "Company Knowledge Deep Dive", "description": "Visit the Learning Centre's Company Knowledge tab and search for a policy relevant to your role. Knowledge is power!", "type": "module_complete", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    # Exploration & Fun
    {"code": "ex_01", "title": "Ask the Hub Assistant", "description": "Ask the Hub Assistant a question about Harris Farm policies or procedures. Try to stump it!", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    {"code": "ex_02", "title": "Review a Hub Page", "description": "Go to the Academy's Site Quality tab and score any Hub page using the rubric. Your reviews improve the Hub!", "type": "prompt_writing", "difficulty": "beginner", "xp_reward": 15, "target_level": "Seed"},
    {"code": "ex_03", "title": "Teach Someone a Pattern", "description": "Pick one of the 7 prompt patterns and explain it to a colleague in your own words. Teaching is learning!", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 20, "target_level": "Sprout"},
    {"code": "ex_04", "title": "Prompt for Your Role", "description": "Write a prompt specifically tailored to a task you do regularly in your job. Make it so good you'd use it tomorrow.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
    {"code": "ex_05", "title": "Explore Market Share", "description": "Visit the Market Share dashboard and find the top 3 postcodes where Harris Farm's share is growing fastest. What patterns do you notice?", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 20, "target_level": "Sprout"},
    {"code": "ex_06", "title": "Data Storytelling", "description": "Write a prompt asking AI to turn 3 data points (you choose) into a compelling 2-paragraph narrative for a team meeting.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    {"code": "ex_07", "title": "Prompt Improvement Challenge", "description": "Find a prompt you've written before and rewrite it to score at least 2 points higher on the rubric. Compare before and after.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    {"code": "ex_08", "title": "Cross-Department Prompt", "description": "Write a prompt that would help someone in a DIFFERENT department than yours. Think about what they need and how AI could help.", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Grower"},
    {"code": "ex_09", "title": "AI Ethics Reflection", "description": "Write a prompt asking AI about the ethical considerations of using AI in grocery retail. What should Harris Farm be careful about?", "type": "prompt_writing", "difficulty": "advanced", "xp_reward": 20, "target_level": "Harvester"},
    {"code": "ex_10", "title": "Innovation Prompt", "description": "Write a prompt asking AI to brainstorm 5 innovative ways Harris Farm could use AI that nobody has tried yet. Be creative!", "type": "prompt_writing", "difficulty": "intermediate", "xp_reward": 25, "target_level": "Sprout"},
]
